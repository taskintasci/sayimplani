...
export default function KorSayim({ onNavigate }) {
  ...
  const filterOptions = useMemo(
    () => computeFilterOptions(korMatched, { filterSearch, filterDurum, filterKategori, filterUrunTipi, filterBlok, filterKoridor, filterSutun, filterKat }),
    [korMatched, filterSearch, filterDurum, filterKategori, filterUrunTipi, filterBlok, filterKoridor, filterSutun, filterKat]
  )
  ...
  }, [korMatched, filterSearch, filterDurum, filterKategori, filterUrunTipi, filterBlok, filterKoridor, filterSutun, filterKat, sortType])
