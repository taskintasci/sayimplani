  ...
  if (rows.length === 0) {
    return (
      <div className="flex flex-col gap-5">
        <div>
          <h1 className="text-xl font-bold text-slate-900">{firmaProfile?.unvan || firmaProfile?.ad || ''} Kör Stok Sayım Raporu</h1>
    ...
    <div className="flex flex-col gap-5 print-content">
      ...
      <div className="flex flex-wrap items-center justify-between gap-y-2">
        ...
        <div className="flex flex-wrap gap-2 no-print">
          ...
          <button
            onClick={() => exportRaporFarklar(discrepancies, session, korManualRows, firmaProfile)}
