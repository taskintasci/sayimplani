...
export default function KorSayimAnalizi({ onNavigate }) {
  ...
  // Bu bileşen 3 şablonda paylaşılıyor (koranaliz / antrepokoranaliz /
  // redbullkoranaliz) — "Sayfaya Git" hedefi aktif şablona göre değişmeli.
  const sayimRoute = firmaProfile?.sablon === SABLON.WMS31 ? 'antrepokor'
    : firmaProfile?.sablon === SABLON.WMS_REDBULL ? 'redbullkor'
    : 'kor'
